...
public void actionPerformed(ActionEvent ae)
{
	  	...
	  	try
	  	{
	  	 if(((t1.getText()).equals(""))&&((t2.getText()).equals("")))
	        ...
	        else
	        {
			 ...
			 con=DriverManager.getConnection("jdbc:mysql://localhost:3307/medicine","root","Sakshi@123");
    ...
    {//list
     ...
     {
		Class.forName("com.mysql.jdbc.Driver");
		con=DriverManager.getConnection("jdbc:mysql://localhost:3307/medicine","root","");
		System.out.println("Connected to database.");
